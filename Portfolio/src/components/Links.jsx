...
function Links() {
  return (
    <div className="bg-green-400  max-sm:m-8 rounded-lg shadow-lg p-2 grid grid-cols-2 gap-4 justify-items-center   md:h-full md:w-full">
      <a
        href="https://leetcode.com/u/aaryan9/"
        target="_blank"
      ...
      <a
        href="https://www.linkedin.com/in/aaryan-anil-kumar-singh-568789250/"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://www.instagram.com/aaryansinghrajput9?igsh=MXQ4cXBvcTR0eGhwYQ=="
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://github.com/Aaryan-9"
        target="_blank"
        rel="noopener noreferrer"
        className="w-16 h-16 bg-[#e1306c] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
      >
